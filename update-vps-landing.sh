...
# VPS Landing Page Update Script
# This will update the landing page on scrdesk.com.tr

ssh root@72.61.138.218 << 'ENDSSH'
...
echo "✅ Landing page güncellendi!"
echo "🌐 Test: https://scrdesk.com.tr"
