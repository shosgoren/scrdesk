...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_scrdesk_password_tip", "Επιβεβαιώστε τον κωδικό του SCRDESK"),
        ...
        ("upgrade_scrdesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον SCRDESK Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("upgrade_remote_scrdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη SCRDESK στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
