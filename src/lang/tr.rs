...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, SCRDESK bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, SCRDESK'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için SCRDESK'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için SCRDESK'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, SCRDESK'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [SCRDESK Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep SCRDESK background service", "SCRDESK arka plan hizmetini sürdürün"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için SCRDESK'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için SCRDESK'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan SCRDESK'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_scrdesk_password_tip", "SCRDESK parolasını doğrulayın"),
