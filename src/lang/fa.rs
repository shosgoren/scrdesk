...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_scrdesk_password_tip", "رمز عبور SCRDESK را تأیید کنید"),
        ...
        ("upgrade_scrdesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید SCRDESK Server Pro لظفا"),
        ...
        ("upgrade_remote_scrdesk_client_to_{}_tip", "لطفاً SCRDESK را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
