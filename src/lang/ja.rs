...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_scrdesk_password_tip", "SCRDESK のパスワードを確認する"),
        ...
        ("upgrade_scrdesk_server_pro_to_{}_tip", "SCRDESK Server Pro をバージョン {} 以上にアップグレードしてください！"),
        ...
        ("upgrade_remote_scrdesk_client_to_{}_tip", "リモート側の SCRDESK クライアントをバージョン {} 以上にアップグレードしてください！"),
