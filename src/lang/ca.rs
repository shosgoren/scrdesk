...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del SCRDESK"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el SCRDESK Server Pro a la versió {} o superior!"),
