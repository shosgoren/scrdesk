...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de SCRDESK..."),
        ...
        ("install_tip", "En alguns casos és possible que el SCRDESK no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el SCRDESK al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al SCRDESK els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al SCRDESK els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al SCRDESK l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «SCRDESK Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep SCRDESK background service", "Manté el servei del SCRDESK en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del SCRDESK, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el SCRDESK al dispositiu remot."),
        ...
        ("Show SCRDESK", "Mostra el SCRDESK"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al SCRDESK els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al SCRDESK els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del SCRDESK en execució."),
        ...
        ("verify_scrdesk_password_tip", "Verifica la contrasenya del SCRDESK"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del SCRDESK, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_scrdesk_server_pro_to_{}_tip", "Actualitzeu el SCRDESK Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el SCRDESK funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de SCRDESK"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del SCRDESK està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del SCRDESK en rerefons"),
        ...
        ("About SCRDESK", "Quant al SCRDESK"),
        ...
        ("upgrade_remote_scrdesk_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
