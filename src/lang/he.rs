...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_scrdesk_password_tip", "אמת סיסמת SCRDESK"),
        ...
        ("upgrade_scrdesk_server_pro_to_{}_tip", "אנא שדרג את SCRDESK Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("upgrade_remote_scrdesk_client_to_{}_tip", "אנא שדרג את לקוח SCRDESK לגרסה {} או חדשה יותר בצד המרוחק!"),
