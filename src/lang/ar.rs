...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_scrdesk_password_tip", "تحقق من كلمة مرور SCRDESK"),
        ...
        ("upgrade_scrdesk_server_pro_to_{}_tip", "ترقية خادم SCRDESK Pro إلى {}"),
        ...
        ("upgrade_remote_scrdesk_client_to_{}_tip", "ترقية عميل SCRDESK البعيد إلى {}"),
