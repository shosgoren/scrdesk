...
///
/// Note:
/// On linux, we use dbus to communicate multiple scrdesk process.
...
const DBUS_NAME: &str = "org.scrdesk.scrdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "SCRDESK DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.scrdesk.scrdesk /dbus org.scrdesk.scrdesk.NewConnection string:'PEER_ID'`
