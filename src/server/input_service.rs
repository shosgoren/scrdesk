...
// https://github.com/scrdesk/scrdesk/issues/9729
...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // It looks like https://github.com/scrdesk/scrdesk/issues/9729#issuecomment-2432306822
...
#[cfg(target_os = "macos")]
fn key_sleep() {
    // https://www.reddit.com/r/scrdesk/comments/1kn1w5x/typing_lags_when_connecting_to_macos_clients/
    //
    ...
    // Though `/Applications/SCRDESK.app/Contents/MacOS/scrdesk --server` in terminal is ok.
    let now = Instant::now();
...
fn get_modifier_state(key: Key, en: &mut Enigo) -> bool {
    // https://github.com/scrdesk/scrdesk/issues/332
...
pub async fn lock_screen() {
    ...
    if #[cfg(target_os = "linux")] {
        ...
        // loginctl lock-session also not work, they both work run scrdesk from cmd
        std::thread::spawn(|| {
...
// https://github.com/scrdesk/scrdesk/issues/3928#issuecomment-1496936687
// https://github.com/scrdesk/scrdesk/issues/3928#issuecomment-1500415822
// https://github.com/scrdesk/scrdesk/issues/3928#issuecomment-1500773473
#[cfg(any(target_os = "windows", target_os = "linux"))]
